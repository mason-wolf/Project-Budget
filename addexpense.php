<?php
    ...
    if(isset($_POST['addexpense'])) {
      $amount = $_POST['amount'];
      if(empty($amount)) {
          $emptyFieldError = "<span style='color:red;float:right;'>Please enter an amount.</span>";
      }
      else {
        ...
        <div class="col-12" style="padding:0px;">
                ...
                <div class="col-6">
                    ...
                    <form method="post" action="AddExpense.php">
                        ...
                        <div class="col-6">    
                            <span class="currency">
                                <input  type="text" class="field"  placeholder="0.00" style="padding-left:17px;" name="amount">
                                <?php if (isset($emptyFieldError)) { echo $emptyFieldError; } ?>
                            </span>
                        </div>
